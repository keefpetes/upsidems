  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-20">
      ...
      <ScrollReveal>
        <div className="prose-none space-y-6 text-ink/85 leading-relaxed">
          <p data-scroll-reveal>
            ...
            Disability is often framed as an individual problem to overcome.
            We take a different view. When people are excluded from nature,
        ...
        <blockquote
          data-scroll-reveal
          className="my-8 border-l-2 border-rust pl-6 font-display text-xl md:text-2xl leading-relaxed italic text-ink"
        >
        ...
        <div className="space-y-4 text-ink/85 leading-relaxed">
          ...
          <p data-scroll-reveal>
            ...
            at intervals that account for fatigue, surface materials that
            work for wheels, canes, and unsteady gaits.
          </p>
          <p data-scroll-reveal>
            The work begins by identifying where systems break down and
            asking how thoughtful design can restore dignity, movement, and
            participation.
          </p>
          <p data-scroll-reveal>
          ...
          <p data-scroll-reveal>
            Our work is informed by lived experience, but it is not limited
            to any single diagnosis. Disability is a common part of the human
            condition. Bodies change over time. Designing for access is
            simply designing for reality.
          </p>
        </div>
        ...
        <div className="space-y-4 text-ink/85 leading-relaxed">
          ...
          <p data-scroll-reveal>
            ...
            requires — not just compliance with codes, but design that
            accounts for fatigue, temperature sensitivity, variable
            mobility, and the cognitive load of constantly working around
            barriers.
          </p>
          <p data-scroll-reveal>
            We carry that knowledge forward. Our work extends to anyone
            facing access challenges in natural and public spaces.
          </p>
        </div>
      </ScrollReveal>
      ...
      <ScrollReveal>
        ...
        <p data-scroll-reveal className="text-ink/85 leading-relaxed">
