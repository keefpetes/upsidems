...
export default async function StoryPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <PlaceholderMedia label="Story image placeholder" aspect="aspect-[16/9]" className="mb-10" art={<StoryMarkArt className="w-full h-full" tone={story.slug === "so-it-looks-like-ms" ? "rust" : "forest"} />} />
      <p className="text-lg leading-relaxed text-ink/85 font-display">
        {story.excerpt}
      </p>
